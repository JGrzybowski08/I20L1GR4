...
public class AktualneWizytyPacjentController implements Initializable {
    ...
    public void handleFiltrujBTAction(ActionEvent event){
        ...
        SpisWizytTV.setItems(AktualneWizytyPacjent.FiltrowaneWizytyGet((String) FiltrCB.getValue(), FiltrTF.getText(), PacjentID ));
    }
    ...
    public void handleOdwolajBTAction(ActionEvent event){
        ModelAktualneWizytyPacjent Wizyta = SpisWizytTV.getSelectionModel().getSelectedItem();
    ...
    public void wypelnijTabele(){
        ...
        SpisWizytTV.setItems(AktualneWizytyPacjent.WszystkieWizytyGet(PacjentID));
    }
