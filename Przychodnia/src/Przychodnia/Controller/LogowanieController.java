...
import Przychodnia.Connection.Logowanie;
...
public class LogowanieController {
    ...
    public void handleLoginBTAction(ActionEvent event) {
        ...
        switch (Konto_Up) {
            case "Administrator":
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Przychodnia/FXML/AdministratorGlowna.fxml"));
...
//                    AGC.setID(Konto_ID);
            ...
            case "Lekarz":
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Przychodnia/FXML/LekarzGlowna.fxml"));
                    Parent root = (Parent) loader.load();
...
//                    LGC.setID(Konto_ID);
            ...
            case "Pacjent":
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Przychodnia/FXML/PacjentGlowna.fxml"));
                    Parent root = (Parent) loader.load();
