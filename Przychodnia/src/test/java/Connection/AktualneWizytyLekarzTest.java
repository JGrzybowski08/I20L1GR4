...
public class AktualneWizytyLekarzTest {
    @Test
    public void WszystkieWizytyGetTest() throws SQLException {
        ...
        String testingPacjent = "testing.pacjent";
        ...
        when(resultSetMock.getString(5)).thenReturn(testingPacjent);
        ...
        // when
        ObservableList<ModelAktualneWizytyLekarz> list = AktualneWizytyLekarz.WszystkieWizytyGet(1);
        ...
        Assert.assertEquals("Name of Lekarz is wrong", list.get(0).getPacjent(), testingPacjent + " " + null);
